        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-6 leading-tight">
              Fuel Impact
              <br />
              <span className="text-3xl md:text-5xl font-semibold text-gray-600">Calculator</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Discover how much fuel costs are impacting your income.
              Get personalized insights and save money on transportation.
            </p>
